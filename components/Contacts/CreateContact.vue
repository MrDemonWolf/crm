                ...
                >
                  <div class="flex-1">
                    ...
                    >
                      ...
                      <!-- Team members -->
                      <div
                        class="px-4 space-y-2 sm:grid sm:grid-cols-3 sm:items-center sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5"
                      >
                        <div>
                          <h3
                        ...
                        <div class="sm:col-span-2">
                          <div class="flex space-x-2">
                            ...
                            <button
                              type="button"
                              class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-gray-400 bg-white border-2 border-gray-200 border-dashed rounded-full hover:border-gray-300 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                            >
                      ...
                      <!-- Privacy -->
                      <fieldset
                        class="px-4 space-y-2 sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5"
                      >
